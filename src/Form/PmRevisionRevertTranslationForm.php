 ...
 */
class PmRevisionRevertTranslationForm extends PmRevisionRevertForm {
  ...
  /**
   * Constructs a new PmRevisionRevertTranslationForm.
   *
  ...
  public function getFormId() {
    return $this->entityId . '_revision_revert_translation_confirm';
  }
  ...
  protected function prepareRevertedRevision(PmContentEntityBaseInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\project_manager\Entity\PmContentEntityBaseInterface $default_revision */
