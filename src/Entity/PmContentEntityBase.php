...
/**
 * Provides the base class for PM content entities.
 */
class PmContentEntityBase extends EditorialContentEntityBase implements PmContentEntityBaseInterface {
  ...
  public function preSaveRevision(EntityStorageInterface $storage, \stdClass $record) {
    ...
    if (!$this->isNewRevision() && isset($this->original) && (!isset($record->revision_log_message) || $record->revision_log_message === '')) {
      ...
      // need to make sure $entity->revision_log_message is reset whenever it is empty.
